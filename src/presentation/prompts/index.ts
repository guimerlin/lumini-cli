...
export async function promptStrategy(): Promise<'raw' | 'deps' | 'bundle' | 'folder'> {
...
export async function promptComponentName(defaultName: string): Promise<string> {
...
export async function promptAddDestination(): Promise<string> {
