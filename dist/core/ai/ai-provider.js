...
export function getAIModel() {
    ...
    switch (provider) {
        case "google": {
            ...
            if (!apiKey) {
                throw new Error("GEMINI_API_KEY não definida. Configure no arquivo .env ou no ambiente.");
            }
        ...
        case "openai": {
            ...
            if (!apiKey) {
                throw new Error("OPENAI_API_KEY não definida. Configure no arquivo .env ou no ambiente.");
            }
